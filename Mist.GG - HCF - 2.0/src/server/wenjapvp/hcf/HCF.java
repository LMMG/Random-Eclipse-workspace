...
import server.wenjapvp.hcf.listener.EnchantLimitListener;
import server.wenjapvp.hcf.listener.FactionCoreListener;
import server.wenjapvp.hcf.listener.FactionListener;
import server.wenjapvp.hcf.listener.PotionLimitListener;
...
//		}.runTaskTimerAsynchronously(getPlugin(), 2400L, 2400L);
	...
	private void registerListeners()
	{
		...
		manager.registerEvents(new FactionCoreListener(this), this);
	}
