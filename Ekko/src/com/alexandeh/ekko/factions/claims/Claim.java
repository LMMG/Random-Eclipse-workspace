...
public class Claim {
    ...
    public boolean isGreaterThan(Claim claim) {
        ...
        if (Ekko.getInstance().getMainConfig().getStringList("FACTION_GENERAL.BYPASS_INSIDE_CHECK").contains(faction.getName())) {
            return false;
        }
    ...
    public void remove() {
        ...
        if (faction instanceof PlayerFaction) {
            ...
            int value = (int) (width * length * Ekko.getInstance().getMainConfig().getDouble("FACTION_CLAIMING.PRICE_MULTIPLIER"));
