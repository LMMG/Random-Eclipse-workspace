...
public class CoreListener implements Listener {
	...
	public void onLogin(PlayerLoginEvent e) {
		if ((!e.getPlayer().isWhitelisted()) && (Bukkit.hasWhitelist()) && (!e.getPlayer().hasPermission("cobalt.mod"))) {
	...
	public void onLoginJoinFull(final PlayerLoginEvent e) {
		if (e.getResult() == PlayerLoginEvent.Result.KICK_FULL) {
			if (e.getPlayer().hasPermission("serverfull.bypass")) {
				...
				e.disallow(PlayerLoginEvent.Result.KICK_OTHER, ChatColor.RED + "&cServer is full! Buy a reserved slot at www.cobalt.rip/store");
			}
		}
	}
