package net.nersa.kitmap.economy;
...
import net.nersa.kitmap.listener.Crowbar;
	...
	public void onPlayerInteract(PlayerInteractEvent event) {
		if (event.getAction() == Action.RIGHT_CLICK_BLOCK) {
			...
			if (state instanceof Sign) {
				...
				} else if (lines[1].equalsIgnoreCase("Poison")) {
					stack = new ItemBuilder(Material.POTION, ChatColor.WHITE + "Splash Potion of Poison", 1, (short) 16452).getItem();
				} else if (lines[1].equalsIgnoreCase("Slowness")) {
					stack = new ItemBuilder(Material.POTION, ChatColor.WHITE + "Splash Potion of Slowness", 1, (short) 16426).getItem();
				} else if (lines[1].equalsIgnoreCase("Weakness")) {
					stack = new ItemBuilder(Material.POTION, ChatColor.WHITE + "Splash Potion of Poison", 1, (short) 16456).getItem();
				} else if (lines[1].equalsIgnoreCase("Harming")) {
					stack = new ItemBuilder(Material.POTION, ChatColor.WHITE + "Splash Potion of Poison", 1, (short) 16428).getItem();
				} else if (lines[1].equalsIgnoreCase("Invis")) {
					stack = new ItemBuilder(Material.POTION, ChatColor.WHITE + "Splash Potion of Poison", 1, (short) 8270).getItem();
