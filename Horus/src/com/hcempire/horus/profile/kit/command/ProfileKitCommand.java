package com.hcempire.horus.profile.kit.command;
...
public class ProfileKitCommand extends HorusCommand {
    @Command(name = "pvp.kit", aliases = {"pvp.class", "class"}, permission = "pvp.class")
    public void onCommand(CommandArgs command) {
        ...
        try {
            ...
            sender.sendMessage(ChatColor.RED + "Invalid class koth.");
            return;
        }
        ...
        if (args.length == 1) {
            if (sender instanceof Player) {
                ...
                sender.sendMessage(org.bukkit.ChatColor.RED + "You're console dumbass.");
                return;
            }
        } else {
