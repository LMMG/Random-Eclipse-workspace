...
public class Crowbar {
    ...
    private static final Material MATERIAL = Material.getMaterial(main.getConfigFile().getString("CROWBAR.ITEM"));
    private static final String NAME = main.getLangFile().getString("CROWBAR.NAME");
    private static final List<String> LORE = main.getLangFile().getStringList("CROWBAR.LORE");
