package com.hcempire.horus.event.koth.procedure;
                ...
                if (itemStack != null && itemStack.getType() != Material.AIR) {
                    ...
                    if (displayName != null) {
                        ...
                        if (displayName.contains("Confirm")) {
                            ...
                            new KothEvent(procedure.name(), new EventZone(procedure.pillars()[0].getOriginalLocation(), procedure.pillars()[1].getOriginalLocation()));
                            return;
                        }
    ...
    public void onInventoryCloseEvent(InventoryCloseEvent event) {
        ...
        if (procedure != null) {
            if (procedure.stage() == KothCreateProcedureStage.CONFIRMATION && event.getInventory().getTitle().contains("Confirm KoTH?")) {
                ...
                }.runTaskLaterAsynchronously(Horus.getInstance(), 2L);
            }
        }
    }
