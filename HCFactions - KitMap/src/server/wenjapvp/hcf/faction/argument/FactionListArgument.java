...
public class FactionListArgument extends CommandArgument {
	...
	private void showList(final int pageNumber, final String label, final CommandSender sender) {
		...
		if (pageNumber > maxPages) {
	     ...
	     sender.sendMessage(ChatColor.GREEN + ChatColor.BOLD.toString() + " Faction List " + ChatColor.GREEN + "-" + ChatColor.GRAY + " (Page " + pageNumber + '/' + maxPages + ')');
		...
		sender.sendMessage(ChatColor.GREEN + ChatColor.BOLD.toString() + " * " + ChatColor.YELLOW + "You are currently on " + ChatColor.GRAY + "Page " + pageNumber + '/' + maxPages + ChatColor.GREEN + '.');
	    sender.sendMessage(ChatColor.GREEN + ChatColor.BOLD.toString() + " * " + ChatColor.YELLOW + "To view other pages, use " + ChatColor.GRAY + '/' + label + ' ' + this.getName() + " <page#>" + ChatColor.GREEN + '.');
		sender.sendMessage(ChatColor.GRAY + BukkitUtils.STRAIGHT_LINE_DEFAULT);
	}
}
