...
import gg.vexus.commands.StaffChatCommand;
...
public class Core extends JavaPlugin implements Listener
{
	...
	{
		String one = C.c("&7[&6&oTip&7] &7Support the KitMap and purchase in-game abilities &6@store.wenjapvp.net!");
		String two = C.c("&7[&6&oTip&7] &7Want to see all the updates follow our twitter &6@WenjaPvP");
		String three = C.c("&7[&6&oTip&7] &760% Sale during the come up to SOTW&6 @store.wenjapvp.net");
