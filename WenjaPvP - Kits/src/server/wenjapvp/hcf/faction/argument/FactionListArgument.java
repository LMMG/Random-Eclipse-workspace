...
public class FactionListArgument extends CommandArgument {
	...
	private void showList(final int pageNumber, final String label, final CommandSender sender) {
		...
		sender.sendMessage(ChatColor.GOLD + ChatColor.BOLD.toString() + " FACTION LIST " + ChatColor.GOLD + "-"
				+ ChatColor.GRAY + " (Page " + pageNumber + '/' + maxPages + ')');
		...
		sender.sendMessage(
				ChatColor.GOLD + ChatColor.BOLD.toString() + " * " + ChatColor.YELLOW + "You are currently on "
						+ ChatColor.GRAY + "Page " + pageNumber + '/' + maxPages + ChatColor.GOLD + '.');
		sender.sendMessage(
				ChatColor.GOLD + ChatColor.BOLD.toString() + " * " + ChatColor.YELLOW + "To view other pages, use "
						+ ChatColor.GRAY + '/' + label + ' ' + this.getName() + " <page#>" + ChatColor.GOLD + '.');
		sender.sendMessage(ChatColor.GOLD + BukkitUtils.STRAIGHT_LINE_DEFAULT);
	}
}