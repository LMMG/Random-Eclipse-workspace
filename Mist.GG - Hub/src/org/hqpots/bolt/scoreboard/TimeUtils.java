package org.hqpots.bolt.scoreboard;
...
public class TimeUtils
{
	...
	public static class IntegerCountdown
	{
		public static String setFormat(Integer value)
		{
			...
			return (hours > 0 ? String.format("%02d" + ":", new Object[] {
					hours
			}) : "") + String.format("%02d:%02d", new Object[] {
					minutes,
					seconds
			});
		}
	...
	public static class LongCountdown
	{
		...
		{
			if (value < TimeUnit.MINUTES.toMillis(1L)) { return getDecimalFormat().format(value / 1000.0D) + "s"; }
