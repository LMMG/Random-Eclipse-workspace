...
public class PlayerEvents implements Listener
{
	...
	public static ItemStack chainmail = ItemStackBuilder.get(Material.CHAINMAIL_LEGGINGS, 1, (short) 0, "&aStaff", mail);
	public static ItemStack dHel = ItemStackBuilder.get(Material.DIAMOND_HELMET, 1, (short) 0, "&aDonator", null);

	static
	{
		mail.add(ChatColor.translateAlternateColorCodes('&', "Staff Kit"));
	}
	...
	public void onPlayerJoin(PlayerJoinEvent e)
	{
		...
		if (p.hasPermission("common.mod") || p.isOp())
		{
			giveStaffKit(p);
		}
		if (p.hasPermission("common.staff") || p.isOp())
		{
			giveRank(p);
		}
	}

	public void giveStaffKit(Player player)
	{
		player.getInventory().setLeggings(chainmail);
		chainmail.addEnchantment(Enchantment.DURABILITY, 3);
	}

	public void giveRank(Player player)
	{
		player.getInventory().setHelmet(dHel);
		dHel.addEnchantment(Enchantment.DURABILITY, 3);
	}
	...
	public void onPlayerJoinEvent(PlayerJoinEvent e)
	{
		...
		player.sendMessage(ChatColor.translateAlternateColorCodes('&', "&a&lStore: &7store.mist.gg"));
		player.sendMessage(ChatColor.translateAlternateColorCodes('&', "&a&lForum: &7mist.gg"));
		player.sendMessage(ChatColor.translateAlternateColorCodes('&', "&a&lTwitter: &7@MistHardcore"));
		player.sendMessage(ChatColor.translateAlternateColorCodes('&', "&7&m------------------------"));
	}
