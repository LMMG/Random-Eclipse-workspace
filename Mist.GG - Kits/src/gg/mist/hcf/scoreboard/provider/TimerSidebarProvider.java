package gg.mist.hcf.scoreboard.provider;
...
import gg.mist.hcf.scoreboard.SidebarEntry;
import gg.mist.hcf.scoreboard.SidebarProvider;
...
public class TimerSidebarProvider implements SidebarProvider {
    ...
    public String getTitle() {
        return ChatColor.GREEN + ChatColor.BOLD.toString() + "Mist" + ChatColor.RED + " [Season 1]";
    }
