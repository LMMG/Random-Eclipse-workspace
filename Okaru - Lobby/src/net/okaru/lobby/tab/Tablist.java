...
public class Tablist {
    ...
    public Tablist update() {
        ...
        Table<Integer, Integer, String> entries = manager.getSupplier().getEntries(this.player);
        ...
        if (useProfiles) {
            ...
            if ((footer = manager.getSupplier().getFooter(this.player)) == null) {
                footer = "";
            }
        ...
        while (i < magic * 20) {
            ...
            if ((team = this.scoreboard.getTeam(name = TAB_NAMES[i])) == null) {
