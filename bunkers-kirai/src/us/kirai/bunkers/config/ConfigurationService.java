package us.kirai.bunkers.config;
...
public class ConfigurationService
{
    ...
    public static final String SCOREBOARD_TITLE = "§9§lKIRAI §c[UHCBunkers]";
    ...
    static {
        databaseFile = new File(Bunkers.getInstance().getDataFolder() + File.separator + "database.yml");
        playerDatabaseFile = new File(Bunkers.getInstance().getDataFolder() + File.separator + "playerDatabase.yml");
