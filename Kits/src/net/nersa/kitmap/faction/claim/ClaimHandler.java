package net.nersa.kitmap.faction.claim;
...
import net.nersa.kitmap.faction.type.*;
...
public class ClaimHandler {
	...
	public static final ItemStack SUBCLAIM_WAND = new ItemBuilder(Material.GOLD_SPADE, 1).displayName(ChatColor.GOLD + "Subclaim Wand").lore(ChatColor.AQUA + "Left or Right Click " + ChatColor.GREEN + "a Block" + ChatColor.AQUA + " to:", ChatColor.GRAY + "Set the first and second position of ", ChatColor.GRAY + "your Subclaim selection.", "", ChatColor.AQUA + "Right Click " + ChatColor.GREEN + "the Air" + ChatColor.AQUA + " to:", ChatColor.GRAY + "Clear your current Subclaim selection.", "", ChatColor.AQUA + "Use " + ChatColor.YELLOW + "/faction subclaim create <name>" + ChatColor.AQUA + " to:", ChatColor.GRAY + "Acquire your selected Subclaim.").build();

	public static final ItemStack CLAIM_WAND = new ItemBuilder(Material.DIAMOND_HOE).displayName(ChatColor.RED + "Claim Wand").lore(ChatColor.AQUA + "Left or Right Click " + ChatColor.GREEN + "a Block" + ChatColor.AQUA + " to:", ChatColor.GRAY + "Set the first and second position of ", ChatColor.GRAY + "your Claim selection.", "", ChatColor.AQUA + "Right Click " + ChatColor.GREEN + "the Air" + ChatColor.AQUA + " to:", ChatColor.GRAY + "Clear your current Claim selection.", "", ChatColor.YELLOW + "Shift " + ChatColor.AQUA + "Left Click " + ChatColor.GREEN + "the Air or a Block" + ChatColor.AQUA + " to:", ChatColor.GRAY + "Purchase your current Claim selection.").build();
	...
	public boolean canSubclaimHere(Player player, Location location) {
		...
		if (plugin.getFactionManager().getFactionAt(location) != playerFaction) {
			player.sendMessage(ChatColor.RED + "This location is not part of your faction's territory.");
			return false;
		}
	...
	public boolean canClaimHere(Player player, Location location) {
		...
		for (int x = locX - CLAIM_BUFFER_RADIUS; x < locX + CLAIM_BUFFER_RADIUS; x++) {
			for (int z = locZ - CLAIM_BUFFER_RADIUS; z < locZ + CLAIM_BUFFER_RADIUS; z++) {
				...
				if (!ConfigurationService.ALLOW_CLAIMING_BESIDES_ROADS && factionAtNew instanceof ClaimableFaction && playerFaction != factionAtNew) {
