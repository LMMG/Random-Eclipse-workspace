package net.nersa.kitmap.faction;

import com.doctordark.util.command.ArgumentExecutor;
import com.doctordark.util.command.CommandArgument;

import net.nersa.kitmap.HCF;
import net.nersa.kitmap.faction.argument.*;
import net.nersa.kitmap.faction.argument.staff.*;
...
public class FactionExecutor extends ArgumentExecutor {
	...
	private final FactionHelpArgument helpArgument;

	public FactionExecutor(HCF plugin) {
		super("faction");
		addArgument(new FactionFixClaimArgument(plugin));
	...
	private void addArgument(FactionHelpArgument factionHelpArgument) {
	...
	public boolean onCommand(CommandSender commandSender, Command command, String label, String[] args) {
		if (args.length < 1) {
			helpArgument.onCommand(commandSender, command, label, args);
			return true;
		}
		...
		if (argument != null) {
			...
			if (permission == null || commandSender.hasPermission(permission)) {
				argument.onCommand(commandSender, command, label, args);
				return true;
			}
		}
