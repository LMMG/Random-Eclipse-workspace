package net.nersa.kitmap.eventgame.crate;
...
public class EventKey extends Key {
	...
	public ItemStack getItemStack() {
		...
		meta.setLore(Lists.newArrayList(ChatColor.GRAY + "Right click a chest in Spawn to redeem your rewards."));
	...
	public ItemStack getItemStack(EventKeyData eventKeyData) {
		...
		ItemMeta meta = stack.getItemMeta();
		meta.setDisplayName(getColour() + getName() + " Key");
		meta.setLore(Lists.newArrayList(ChatColor.GRAY + "Right click a chest in Spawn to use.", ChatColor.GOLD + eventKeyData.getEventType().getDisplayName() + ChatColor.GOLD + " Inventory " + ChatColor.GOLD + eventKeyData.inventoryNumber));
		stack.setItemMeta(meta);
		return stack;
	}
