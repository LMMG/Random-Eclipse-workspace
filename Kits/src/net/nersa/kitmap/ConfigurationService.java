...
public class ConfigurationService {
	...
	public static String DONATE_URL = "www.nersa.net/store";
	...
	public static String SCOREBOARD_TITLE = ChatColor.GOLD.toString() + ChatColor.BOLD + "   Cobalt " +  ChatColor.RED + "[Kits]   ";
