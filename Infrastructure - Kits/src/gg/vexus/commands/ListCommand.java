...
public class ListCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		sender.sendMessage("§2There are currently §o§l" + Bukkit.getOnlinePlayers().length + "§r§2 players online.");
		sender.sendMessage("§2Staff Online§7: ");
		...
		sender.sendMessage("§2No staff online? Join our Teamspeak @ §lts.mist.gg§e.");
		sender.sendMessage("§7§m------------------------------------------------------------");
		return true;
	}
